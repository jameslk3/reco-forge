...
//! Example usage:
//! ```no_run
//! use reco_forge::{create_model, pass_item, Data, Tensor, HashMap}; // Can also use pass_description
//! 
...
pub fn pass_description(node_embeddings: &HashMap<Data, Option<Tensor>>, description_input: String, tags_input: String, num_recommendations: usize) -> Result<Vec<String>, ()> {
    ...
    let recommendations = get_recommendations(node_embeddings, &input_embedding, &tags_input, num_recommendations);
    recommendations
}
